...
thankyou_page () {
	...
	echo "
		<br>
		<italic-black>
			The download speed for free WiFi is 10 mbps. You can access 100 mbps download speed for only Rs. 30 per day. 

			For more information contact on Whatsapp number 9867872019  
			<br>
		</italic-black>
	"
